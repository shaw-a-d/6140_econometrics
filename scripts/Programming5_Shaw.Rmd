...
Yes, this relationship is causal because the e
...
If the proportion of defiers were to increase, the coefficeint for the treatment variable increases distorting the effect of treatment on y because now the first-stage effects becomes .60-.10 = .50 so as the denominator shrinks the estimate incorrectly grows larger. 
...
If we subset the data to only those whose status is affirmative for compiers, inccorect assignments from always-takers and defiers is stripped out so the result is an even more precise estimate. 
